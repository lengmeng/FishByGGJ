...
namespace FluxEditor
{
	public class FEventEditor : FEditor
	{
		...
		public override FSequenceEditor SequenceEditor { get { return TrackEditor.SequenceEditor; } }
...
//		}
//
//		protected override void Init( FObject obj, FEditor owner )
//		{
//			base.Init( obj, owner );
//			_evt = (FEvent)obj;
//		}
...
//		}
		...
		public override float Height { get { return TrackEditor.Height; } }
...
//						keyframeOnSelect = evt.End;
					...
					else if( _eventRect.Contains( mousePos ) )
					{
						...
						_mouseOffsetFrames = SequenceEditor.GetFrameForX( mousePos.x - Rect.x ) - Evt.Start;
			...
			case EventType.MouseDrag:
				if( EditorGUIUtility.hotControl != 0 )
				{
	                if( EditorGUIUtility.hotControl == GuiId )
			    	{
					    ...
					    int t = SequenceEditor.GetFrameForX( Event.current.mousePosition.x - Rect.x ) - _mouseOffsetFrames;
	                ...
	                else if( EditorGUIUtility.hotControl == _leftHandleGuiId || EditorGUIUtility.hotControl == _rightHandleGuiId )
	                {
						...
						int t = SequenceEditor.GetFrameForX( Event.current.mousePosition.x - Rect.x );
